...
import { showMoreFunction } from "../utils/showMoreLessFunction.mjs";
...
export const allListings = async () => {
  if (path === "/") {
    ...
    showMoreFunction(showMoreBtn, limitNr, offsetNr, maxLimit, URL_limited_to_10, path);
    search(jsonAllListings, path);
  }
};
